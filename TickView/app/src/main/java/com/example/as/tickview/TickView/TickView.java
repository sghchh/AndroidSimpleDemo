package com.example.as.tickview.TickView;
...
import com.example.as.tickview.R;
...
public class TickView extends View {
    ...
    private void initAttrs(AttributeSet attributeSet){
        ...
        TypedArray typedArray = getContext().obtainStyledAttributes(attributeSet, R.styleable.TickView);
